...
public class ActionReceiver extends BroadcastReceiver implements com.example.kuime.IaResultHandler {
...
*/
    @Override
    public void onResult(com.example.kuime.CaResult Result) {
